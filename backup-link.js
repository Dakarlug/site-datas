...
DownLoad  = function(){
  // store all urls of images and pdf files from dakarlug.org 
  // into a text file named links.txt
  this.s     = []
  this._urls = _urls ||{}
  this.backupLink= function(){
    console.log('Ok')
    fs.writeFileSync( "links.md", this.s.join('\n'));
   
  }
  // request
  this.scrapper =  function(_url){
    self = this
    request(_url, 
